      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/removal-service" className="hover:text-white">Removal Service</Link></li>
            <li><Link to="/book-and-pay" className="hover:text-white">Book & Pay</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>info@whiteglovecourier.co.uk</li>
